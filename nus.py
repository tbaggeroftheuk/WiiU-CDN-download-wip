...
def parse_tmd(raw):
    ...
    for i in range(content_count):
        ...
        size = int.from_bytes(raw[offset+8:offset+10], "big")
...
def save_json_report(title_id, entries, stats, filename, title_name="Unknown Title"):
    data = {
        "title_id": title_id,
...
def process_content(entry, base_url, title_id, download_dir, force):
